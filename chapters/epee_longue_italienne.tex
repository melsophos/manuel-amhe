...
\footnotetext{Mon approche de l'épée longue italienne a été influencée Romain Wenz.}
...
\footnotetext{Cette section s'inspire de~\cite{campo:dijon:posta_frontale:2015}.}
...
\footnotetext{Cette section s'inspire de~\cite{petit:dijon:close_longword:2015}.}

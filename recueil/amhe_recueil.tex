...
\begin{center}
	...
	Ce texte est diffusé sous la licence libre \\
...
\input{principes/intro_escrime}
\input{principes/structure}
\input{principes/deplacements}
\input{principes/attaque_defense}
\input{principes/concepts_generaux}
\input{chapters/principes_divers}


\part{Combat rapproché}

\input{principes/mains_nues}
\input{chapters/mains_nues_armes}
\input{principes/dague}
...
\input{principes/conventions}
\input{principes/securite}
\input{chapters/traites}
\input{chapters/glossaire}
% part : l'entraînement ?
\input{chapters/pedagogie}
\input{chapters/echauffement}


\microtypesetup{protrusion=false}
\input{principes/liste_defs}
\microtypesetup{protrusion=true}

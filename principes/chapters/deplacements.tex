...
Dans les deux cas le mouvement est de faible amplitude -- moins de la largeur des épaules -- afin de garder l'équilibre et de pouvoir réagir rapidement (par exemple en changeant de direction) -- et les pieds restent toujours écartés.
Ainsi on préférera généralement un grand nombre de petits déplacements plutôt que quelques grandes enjambées.
Lors d'une marche c'est la jambe arrière qui pousse et qui donne l'impulsion, et inversement la jambe avant pousse lors d'une retraite.
Rappelons que tous ces mouvements se font avec les jambes fléchies.


\begin{definition}[Marche]
	\label{dep:def:marche}
...
% TODO: "changement de pied dominant"
...
\begin{exercice}
	\label{dep:ex:déplacement-contact-meneur}
	
	\tags{mains nues}

	\obj{Se déplacer en connexion avec son partenaire.}

	\A et \D sont en garde bras droits tendus devant et en contact au niveau du poignet.
	\A est le meneur : il se déplace en effectuant les différents déplacements ci-dessus tandis que \D le suit en maintenant la distance et le contact des bras.
\end{exercice}
...
\begin{exercice}[Réalisation des déplacements]
	\label{dep:ex:réalisation-déplacements}
	\index{echauffement@échauffement!exercice}
	
	\tags{échauffement}

	\obj{Réaliser les différents déplacements à des rythmes variables.}

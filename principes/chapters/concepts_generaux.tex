...
\begin{exercice}[Zone hors distance -- actif]
	
	\obj{Apprendre à mesurer la zone d'attaque de l'adversaire.}
...
\begin{exercice}[Zone hors distance -- passif]
...
\begin{exercice}[Zone d'attaque -- passif]
	
	\obj{Apprendre à mesurer sa propre zone d'attaque.}
...
\begin{exercice}[Zone d'attaque -- actif]
...
\begin{exercice}
	...
	\obj{Mesurer la distance pour une attaque et sa remise.}
...
\begin{exercice}
	...
	\obj{Mesurer la distance pour une attaque.}
...
\begin{exercice}
	...
	\obj{S'entraîner à repérer le Vor et le Nach et à agir en conséquence.}
...
\begin{exercice}[Structure par la lutte -- variantes]
...
% TODO: définition pour le centre, via le plan vertical

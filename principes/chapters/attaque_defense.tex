...
\begin{coup}[Coup montant (inférieur)]
	...
	\index{coup!montant}
	\index{coup!ascendant|see{coup montant}}
...
\begin{exercice}[Mouvements dans le vide]
	...
	\obj{Analyser le maniement d'une arme.}
...
\begin{exercice}[Repérer un appel]

	\obj{S'entraîner à ne pas faire d'appels et à les repérer.}
...
% TODO: trouver un exercice où \D fait quelque chose s'il voit un appel (attaque...)
...
\begin{exercice}
	...
	\obj{Repérer des cibles avec une alternance de hauteur.}
...
\begin{exercice}[Attaques aux avancées]
	...
	\obj{Voir dans quelles attaques ne permettent pas de protéger ses avancées.}
...
\begin{exercice}
	\obj{Perdre la peur d'être touché par l'arme de son équipier, apprendre à gérer sa force et la distance.}
...
\begin{exercice}[Série avec garde]
	...
	\obj{Travailler les déplacements en attaquant.}
...
% TODO: on parle de parade franche dans cette section
...
% TODO: série de 5 : toute pronation sauf haut-gauche
\begin{exercice}[Série avec défense]
	\label{att:ex:série-défense}
	\tags{échauffement}

	\obj{Travailler les défenses sur toutes les cibles.}
...
\begin{exercice}[Parade franche à mains nues]
	\tags{mains nues}
	
	\obj{S'entraîner à réaliser une parade franche.}
...
\begin{exercice}[Parer en quarte]
	...
	\obj{S'entraîner à réaliser une parade franche en pivotant le hanches.}
...
\begin{exercice}[Absorption à mains nues]
	
	\tags{mains nues}
	
	\obj{S'entraîner à absorber une attaque.}
...
\begin{exercice}[Déviation à mains nues]
	
	\tags{mains nues}
	
	\obj{S'entraîner à dévier une attaque.}
...
% penser à esquiver en se positionnant face à l'adversaire, pas de dos

\begin{exercice}
	\tags{mains nues}
	\obj{Esquiver après une attaque.}
...
% TODO: exercice : frappe descendante de \A avec le poing, \D esquive et et lève les bras en protections puis touche à l'épaule des deux mains ; 1030894
% TODO: exercice : frappe à l'épée de \A, \D esquive et frappe (en vérifiant la distance)
% TODO: exercice : \D commence en garde basse, frappe à l'épée de \A, \D esquive et vient couvrir par dessus, puis frappe (en vérifiant la distance)
% TODO: exercice : \D commence en garde basse, frappe à l'épée de \A, \D esquive et couvre en prime/seconde haute, puis frappe (en vérifiant la distance)
% TODO: exercice : \A et \D se déplace, à un moment l'un lance une attaque verticale avec la main, l'autre esquive
% TODO: exercice : \A fait une attaque presque courte, \D esquive en reculant/se penchant en arrière
...
\begin{exercice}
	\obj{Improviser une défense simple sur un coup.}
...
% TODO: déplacer ces exercices ailleurs ?
...
\begin{exercice}
	...
	\obj{Saisir une opportunité pour placer une attaque.}
...
\begin{exercice}
	...
	\obj{Attaquer en continuant de garder le contrôle de l'adversaire.}
...
\begin{exercice}
	...
	\obj{Attaquer après avoir absorber un coup.}
